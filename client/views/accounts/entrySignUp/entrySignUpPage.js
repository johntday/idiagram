...
Template.entrySignUpPage.helpers({
  ...
  showSignupCode: function() {
    return AccountsEntry.settings.showSignupCode && appState.showSignUpCode;
  },
  logo: function() {
...
Template.entrySignUpPage.events({
  'submit #signUp': function(event, t) {
    ...
    if (appState.showSignUpCode && AccountsEntry.settings.showSignupCode && signupCode.length === 0) {
