...
Diagrams.after.insert(function (userId, doc) {
    console.log('Diagrams.after.insert');

    Meteor.call('Users.update.lastModified', doc, function(error, retValue) {
        if(error){
            console.log("diagrams.js/3", "Users.update.lastModified", {'error': error, 'retValue': retValue});
...
//    console.log(doc);
//});
//Diagrams.after.remove(function (userId, doc, fieldNames, modifier, options) {
//    console.log(doc);
//});
/*------------------------------------------------------------------------------------------------------------------------------*/
